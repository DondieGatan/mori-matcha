export const SUGAR_DATA = {
  'classic-matcha-latte': { unit: 'Agave Syrup', levels: { '25%': 5, '50%': 8, Regular: 15, Sweet: 20 } },
...
export const TIKTOK_URL = 'https://www.tiktok.com/@mori_matchaofficial?is_from_webapp=1&sender_device=pc'
